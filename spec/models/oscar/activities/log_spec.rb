...
RSpec.describe Oscar::Activities::Log, type: :model do
  ...
  let(:app_log){ LogSpecApplicationLog.create!(note: "n") }
  ...
  describe "readonly after persistence" do
    it "raises ActiveRecord::ReadOnlyRecord on update after create" do
      log = described_class.create!(actor: actor, target: target, application_log: app_log, target_event: "done")
      expect {
